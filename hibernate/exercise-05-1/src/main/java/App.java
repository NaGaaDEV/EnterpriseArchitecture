...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Order order1 = new Order(LocalDate.now().minusDays(1), Arrays.asList(orderLine1, orderLine2));
        Order order2 = new Order(LocalDate.now().minusDays(2), Arrays.asList(orderLine3));

        Customer customer1 = new Customer("Joe", "Gato");
